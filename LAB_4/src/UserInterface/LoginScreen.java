...
private void populateRoleCombo() {
    ...
    SupplierWorkAreaJPanel supplierPanel = new SupplierWorkAreaJPanel(mainWorkArea, null); // Set supplier to null initially
    ...
    private void updateSupplierVisibility() {
        ...
        if((cmbRoles.getSelectedItem()==null) || (cmbRoles.getSelectedItem().getClass()==
                AdminWorkAreaJPanel.class)){
